            ...
            <div className='flex items-center justify-center mt-[20vh]'>
                <div className='w-[60%]'>
                    ...
                    <p className='text-white text-[20px]'>Tengo 22 años, soy de Cartagena de Indias, Colombia. Desde 2018 estudio Ing. de Sistemas en
                        <a href="https://tecnologicocomfenalco.edu.co/" target="_blank" rel="noreferrer" className='text-blue-500 ease-in duration-300 hover:text-[#0cbeff]'> Fundación Universitaria Tecnológico Comfenalco</a>,
                        ...
                        <span className='text-[15px]'> Ver información completa en mis perfiles de
                            <a href="https://www.linkedin.com/in/sebastian-chico-80802625b/"
                                target="_blank"
                                className='text-blue-500 ease-in duration-300 hover:text-[#0cbeff]'
